...
@section('content')
    <form action="/product" method="post" enctype="multipart/form-data">
        @csrf
        <h1 class="alert text-primary h2 text-center text-decoration-underline" >Product Form</h1>
        <div class="container border" style="background-color: peru">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Product Name"
                    value="{{ old('name') ?? 'Soan Papdi' }}">
            </div>
            <div class="mb-3">
                <label for="flavour">Product Flavour :</label>
                <input type="text" class="form-control" name="flavour" id="flavour" value="{{ old('flavour') }}"
                    placeholder="Enter Flavour" list="sug">
                <datalist id="sug">
                ...
                {{-- <div class="row mb-3" id="child_1">
                    <div class="col-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="madewith[]" id="madewith" class="form-select">
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="btn btn-outline-secondary" name="weight_type[]" id="button-addon2">
                                <option>Gm</option>
                                <option>Kg</option>
                            </select>
                        </div>
    ...
    <div class="col-4">
        <label for="madewith">Made With:</label>
        <div class="input-group mb-3">
            <select name="price[madewith][]" class="form-select">
                <option>Vegetable Oil</option>
                <option>Desi Ghee</option>
            </select>
        </div>
    ...
    <div class="col-4">
        ...
        <div class="input-group mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="other" multiple name="other_image[]"
                    accept="image/*,video/-">
            </div>
            <div class="mb-3">
